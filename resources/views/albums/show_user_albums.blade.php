...
<div class='col-md-3 col-sm-3 picture'>
    ...
    <div class="card-footer author">
        ...
        <div class='div-comments'>
            ...
            @endif
            <span class='image-comments'>Average rating: <b>{{$album->average_rating()}} </b></span><br/>
            <span class='image-comments'>Comments enabled: <b>{{$album->active_comments ? 'yes' : 'no'}} </b></span><br/>
            <span class='image-comments'>Ratings enabled: <b>{{$album->active_ratings ? 'yes' : 'no'}} </b></span><br/>
            <span class='image-comments'>Album visibility: <b>{{$album->visibility}} </b></span><br/>
            ...
            <button class="btn-info btn link col-md-12" id="buttonTestClick" value="{{URL::asset('/show_alb/'.$album->upload_link)}}" type="button">Copy link</button>
            @endif
            </div>
            <br/>
            <div class='row text-center'>
            <a class="col-md-12" href="{{URL::asset('/albums/'.$album->id.'/edit')}}"><button class="btn-info btn col-md-12"  value="" type="button">Edit album</button></a>
            </div>
            <br/>
            <div class='row text-center'>
            <a class="col-md-12" href="{{URL::asset('/albums/'.$album->id.'/destroy')}}"><button class="btn-info btn col-md-12"  value="" type="button">Delete album</button></a>
            </div>
