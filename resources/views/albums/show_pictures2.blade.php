...
<div class='col-md-3 col-sm-3 picture'>
    ...
    <div class="card-footer author">
        ...
        <div class='div-comments'>
                ...
                <div class='{{$picture->id}}'>
                    @if (isset($picture->users_rate))
                    @for ($c=0; $c<5; $c++)
                    
                   
                        @if ($c < $picture->picture->user_rate->rate)                   
    ...
    <span class='image-comments'>Average rating: <b> @if (isset($picture->picture)) {{$picture->picture->average_rating()}} @endif </b></span>
    @endif </br>
...
<?php if($a%3==0) echo "</div>";?> @endforeach
    ...
    <div class='col-md-12 col-sm-12 picture'>
        ...
        @endif
         @if ($pictures[0]->active_comments==true) 
        ...
        <div class="card-footer author">
            ...
            @endphp
                @include('comments.create_fast_album_comment') @endif
        </div>
    </div>
