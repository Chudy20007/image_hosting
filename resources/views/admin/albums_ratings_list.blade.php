  ...
  <table class="table table- bordered table-hover">
    ...
    <tbody>
      ...
      <tr class="table-active">
        ...
        <td>{{$rate->id}}</td>
        <td><a class='profile-data' href="{{URL::asset('albums/'.$rate->album->id)}}">{{$rate->album->title}}</a></td>
        <td><a class='profile-data' href="{{URL::asset('user/'.$rate->user->id)}}">{{$rate->user->name}}</a></td>
        <td>{{$rate->rate}}</td>
        <td><a class='profile-data' href="{{ URL::asset('/albums/'.$rate->album->id)}}"><img class="img-thumbnail small-img-admin-panel" src="{{ URL::asset($rate->album->title_photo)}}"></a></td>
