  ...
  <table class="table table- bordered table-hover">
    ...
    <tbody>
      ...
      <tr class="table-active">
        ...
        <td>{{$picture->id}}</td>
        <td>
          <a class='profile-data' href="{{URL::asset('user/'.$picture->user_id)}}">{{$picture->name}}</a>
        </td>
        <td>{{$picture->title}}</td>
        <td>
          <a class='profile-data' href="{{ URL::asset($picture->source)}}">
            <img class="img-thumbnail small-img-admin-panel" src="{{ URL::asset($picture->source)}}">
          </a>
        </td>
