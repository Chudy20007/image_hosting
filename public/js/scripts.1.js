            ...
            <div class="card-footer author">
                ...
                <div class="div-comments">
                    ...
                    <a href="pictures/${picture.id}">
                        ...
                        <br>
                        <span class="image-comments">Active comments: <b>${picture.active_comments == true ? 'yes' : 'no'} </b></span> 
                        <br>
                        <span class="image-comments">Active ratings: <b>${picture.active_ratings == true ? 'yes' : 'no'} </b></span> 
                        <br>
                </div>
            </div>
...
$('#find-button-alb').on('click', function () {
   ...
   let url = window.location.href;
    ...
    $('.admin-div').on('mouseenter', function () {
        ...
        $(this).next().children().slideDown(1500).css('display', 'block');

    })

    $('.menuOl').on('mouseleave', function () {

        $(this).children().slideUp(1500);
